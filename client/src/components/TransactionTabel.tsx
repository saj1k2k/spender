...
const TransactionTabel: FC<ITransactionTabel> = ({ limit = 3 }) => {
  ...
  return (
    <>
      <ReactPaginate
        ...
        previousClassName="text-white py-1 px-2 bg-slate-800 rounded-sm text-sm"
        nextClassName="text-white py-1 px-2 bg-slate-800 rounded-sm text-sm"
      ...
      <div className="px-4 py-3 mt-4 bg-slate-800 rounded-md">
